...
export default function Page() {
  return <div className="flex flex-col items-center gap-5">
    ...
    <div className="flex flex-col gap-1.5 w-md">
      <Label htmlFor="" className="text-slate-900 font-medium leading-5" >Correo electrónico</Label>
      <Input className="border-slate-300 placeholder:leading-6 placeholder:text-slate-400" type="email" placeholder="Ingrese el correo electrónico" />
    </div>
  </div>;
}