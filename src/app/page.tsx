...
export default function Home() {
  ...
  <div className="w-screen h-screen relative flex flex-col justify-around items-center">
    ...
    <div className="flex items-center gap-4 top-44">
      ...
      <h1 className="text-zinc-800 font-bold text-[64px] leading-[23px] tracking-[0px]">VivaMedellín</h1>
    </div>
    ...
    <div className="flex gap-10 bg-accent w-fit h-fit py-5 px-10 rounded-md">
      <Link className="leading-2 font-semibold text-sky-500" href="/register">Registrarse</Link>
      <Link className="leading-2 font-semibold text-sky-500" href="/login">Iniciar sesión</Link>
    </div>
  </div>
  </>);
}
